...
def crem_language():
    ...
    layout_language_eng = [[all_imp.pSG.Button(button_eng[0], focus = False, key = "eng", size = (width, 0))],
                           [all_imp.pSG.Button(button_eng[1], focus = False, key = "esp", size = (width, 0))],
                           [all_imp.pSG.Button(button_eng[2], focus = False, key = 800, size = (width, 0))]]
    layout_language_esp = [[all_imp.pSG.Button(button_esp[0], focus = False, key = "eng", size = (width, 0))],
