...
def create_remove_enc_dec():
    ...
    input_column_enc_eng = [[all_imports.pSG.Text(inp_out_eng[0])], [
        all_imports.pSG.Multiline(autoscroll = True, enable_events = False, key = "input", size = (width2, 10))], [
                                all_imports.pSG.Button(enc_dec_mode_eng[0], focus = False, key = "enc",
                                                       size = (width3, 0)),
                                all_imports.pSG.Button(button_eng[1], focus = False, key = "xclipp",
                                                       size = (width3, 0))]]
    ...
    input_column_dec_eng = [[all_imports.pSG.Text(inp_out_eng[0])], [
        all_imports.pSG.Multiline(autoscroll = True, enable_events = False, key = "input", size = (width2, 10))], [
                                all_imports.pSG.Button(enc_dec_mode_eng[1], focus = False, key = "dec",
                                                       size = (width3, 0)),
                                all_imports.pSG.Button(button_eng[1], focus = False, key = "xclipp",
                                                       size = (width3, 0))]]
    ...
    input_column_sig_eng = [[all_imports.pSG.Text(inp_out_eng[0])], [
        all_imports.pSG.Multiline(autoscroll = True, enable_events = False, key = "input", size = (width2, 10))], [
                                all_imports.pSG.Button(enc_dec_mode_eng[2], focus = False, key = "sig",
                                                       size = (width3, 0)),
                                all_imports.pSG.Button(button_eng[1], focus = False, key = "xclipp",
                                                       size = (width3, 0))]]
    ...
    input_column_enc_esp = [[all_imports.pSG.Text(inp_out_esp[0])], [
        all_imports.pSG.Multiline(autoscroll = True, enable_events = False, key = "input", size = (width2, 10))], [
                                all_imports.pSG.Button(enc_dec_mode_esp[0], focus = False, key = "enc",
                                                       size = (width3, 0)),
                                all_imports.pSG.Button(button_esp[1], focus = False, key = "xclipp",
                                                       size = (width3, 0))]]
    ...
    input_column_dec_esp = [[all_imports.pSG.Text(inp_out_esp[0])], [
        all_imports.pSG.Multiline(autoscroll = True, enable_events = False, key = "input", size = (width2, 10))], [
                                all_imports.pSG.Button(enc_dec_mode_esp[1], focus = False, key = "dec",
                                                       size = (width3, 0)),
                                all_imports.pSG.Button(button_esp[1], focus = False, key = "xclipp",
                                                       size = (width3, 0))]]
    ...
    input_column_sig_esp = [[all_imports.pSG.Text(inp_out_esp[0])], [
        all_imports.pSG.Multiline(autoscroll = True, enable_events = False, key = "input", size = (width2, 10))], [
                                all_imports.pSG.Button(enc_dec_mode_esp[2], focus = False, key = "sig",
                                                       size = (width3, 0)),
                                all_imports.pSG.Button(button_esp[1], focus = False, key = "xclipp",
                                                       size = (width3, 0))]]
    ...
    layout_text_enc_eng = [[all_imports.pSG.Column(input_column_enc_eng, element_justification = "center")],
                           ...
                           [all_imports.pSG.Column(output_column_enc_eng, element_justification = "center")], [
                               all_imports.pSG.Button(button_eng[0], focus = False, key = "xclipc", size = (width1, 0),
                                                      visible = False),
                               all_imports.pSG.Button(button_eng[2], focus = False, key = 800, size = (width1, 0)),
                               all_imports.pSG.Button(button_eng[3], focus = False, key = 600, size = (width1, 0))]]
    ...
    layout_text_sig_eng = [[all_imports.pSG.Column(input_column_sig_eng, element_justification = "center")],
                           ...
                           [all_imports.pSG.Column(output_column_sig_eng, element_justification = "center")], [
                               ...
                               all_imports.pSG.Button(button_eng[2], focus = False, key = 800, size = (width1, 0)),
                               all_imports.pSG.Button(button_eng[3], focus = False, key = 600, size = (width1, 0))]]
    layout_text_ver_eng = [[all_imports.pSG.HSeparator()],
    ...
    layout_text_enc_esp = [[all_imports.pSG.Column(input_column_enc_esp, element_justification = "center")],
                           ...
                           [all_imports.pSG.Column(output_column_enc_esp, element_justification = "center")], [
                               all_imports.pSG.Button(button_esp[0], focus = False, key = "xclipc", size = (width1, 0),
                                                      visible = False),
                               all_imports.pSG.Button(button_esp[2], focus = False, key = 800, size = (width1, 0)),
                               all_imports.pSG.Button(button_esp[3], focus = False, key = 600, size = (width1, 0))]]
    ...
    layout_text_sig_esp = [[all_imports.pSG.Column(input_column_sig_esp, element_justification = "center")],
                           ...
                           [all_imports.pSG.Column(output_column_sig_esp, element_justification = "center")], [
                               ...
                               all_imports.pSG.Button(button_esp[2], focus = False, key = 800, size = (width1, 0)),
                               all_imports.pSG.Button(button_esp[3], focus = False, key = 600, size = (width1, 0))]]
    layout_text_ver_esp = [[all_imports.pSG.HSeparator()],
    ...
    mes_enc_eng = all_imports.pSG.Window("EZPZ PGP - " + enc_dec_mode_eng[0], layout_text_enc_eng, disable_close = True,
                                         element_justification = "center")
    mes_dec_eng = all_imports.pSG.Window("EZPZ PGP - " + enc_dec_mode_eng[1], layout_text_dec_eng, disable_close = True,
                                         element_justification = "center")
    mes_sig_eng = all_imports.pSG.Window("EZPZ PGP - " + enc_dec_mode_eng[2], layout_text_sig_eng, disable_close = True,
                                         element_justification = "center")
    mes_ver_eng = all_imports.pSG.Window("EZPZ PGP - " + enc_dec_mode_eng[3], layout_text_ver_eng, disable_close = True,
                                         element_justification = "center")
    mes_enc_esp = all_imports.pSG.Window("EZPZ PGP - " + enc_dec_mode_esp[0], layout_text_enc_esp, disable_close = True,
                                         element_justification = "center")
    mes_dec_esp = all_imports.pSG.Window("EZPZ PGP - " + enc_dec_mode_esp[1], layout_text_dec_esp, disable_close = True,
                                         element_justification = "center")
    mes_sig_esp = all_imports.pSG.Window("EZPZ PGP - " + enc_dec_mode_esp[2], layout_text_sig_esp, disable_close = True,
                                         element_justification = "center")
    mes_ver_esp = all_imports.pSG.Window("EZPZ PGP - " + enc_dec_mode_esp[3], layout_text_ver_esp, disable_close = True,
                                         element_justification = "center")
